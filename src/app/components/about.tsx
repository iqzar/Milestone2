    ...
    mt-10 text-white text-center animate-zoomIn">My Services</h2>
        ...
        <motion.div
            ...
            >
                ...
                <p className='font-poppins text-xs text-left mt-2 leading-relaxed'>I develop clear and actionable strategies to ensure each project is aligned with client goals, setting a strong foundation for design and development.</p>
            </motion.div>
            <motion.div
              className='border border-green-200 rounded-xl px-2 pt-2 md:w-4/5 md:h-28 h-auto w-72 md:ml-0 ml-10'
              initial="hidden"
            ...
            >
                ...
                <p className='font-poppins text-xs text-left mt-2 leading-relaxed'>I create eye-catching CVs, social media posts, and ads on Canva, blending visual appeal with brand consistency to make a lasting impression.</p>
            </motion.div>
        </div>
        ...
        <motion.div
            ...
            >
                ...
                <p className='font-poppins text-xs text-left mt-2 leading-relaxed'>Specializing in front-end development, I design responsive and user-friendly websites that provide seamless experiences across devices.</p>
            </motion.div>
            <motion.div
              className='border border-green-200 rounded-xl px-2 pt-2 md:w-4/5 md:h-28 h-auto w-72 md:ml-0 ml-10'
              initial="hidden"
            ...
            >
                ...
                <p className='font-poppins text-xs text-left mt-2 leading-relaxed'>I conduct research to understand user needs, ensuring that design decisions are backed by insights for improved user satisfaction and engagement.</p>
            </motion.div>
        </div>
